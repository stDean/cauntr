...
import { createJWT, generateVerificationToken, handleOtpForCompany, } from "../../../utils/authHelpers";
...
describe("AuthController", () => {
    ...
    describe("createCompany", () => {
        it("should create a company and return payment URL", async () => {
            ...
            handleOtpForCompany.mockResolvedValue(undefined);
        ...
        it("should throw an error when payment initialization fails", async () => {
            ...
            await expect(AuthController.createCompany(req, res)).rejects.toThrow("Payment gateway initialization failed");
            await expect(AuthController.createCompany(req, res)).rejects.toThrow(CustomAPIError);
        });
    });
    describe("verifyOTP", () => {
        it("should verify OTP and complete registration", async () => {
            ...
            paystackService.createSubscription.mockResolvedValue({
                error: null,
                subscription: {
            ...
            createJWT.mockReturnValue("jwt-token");
        ...
        it("should throw an error if OTP is missing", async () => {
            ...
            await expect(AuthController.verifyOTP(req, res)).rejects.toThrow(BadRequestError);
        });
    ...
    describe("resendRegistrationOTP", () => {
        it("should resend the registration OTP when the company exists", async () => {
            ...
            emailService.sendVerificationOTP.mockResolvedValue({});
        ...
        it("should throw an error if the company does not exist", async () => {
            ...
            // Act & Assert: Expect a BadRequestError.
            await expect(AuthController.resendRegistrationOTP(req, res)).rejects.toThrow(BadRequestError);
        });
    });
    describe("login", () => {
        ...
        it("should throw an error if email or password is missing", async () => {
            ...
            req.body = { email: "test@test.com" };
            // Act & Assert: Expect a BadRequestError.
            await expect(AuthController.login(req, res)).rejects.toThrow(BadRequestError);
        });
    ...
    describe("forgotPassword", () => {
        ...
        it("should throw an error if email or password is missing", async () => {
            ...
            // Act & Assert:
            await expect(AuthController.forgotPassword(req, res)).rejects.toThrow(BadRequestError);
        });
    });
    describe("resendOTP", () => {
        ...
        it("should throw an error if user is not found", async () => {
            ...
            prisma.user.findUnique.mockResolvedValue(null);
            // Act & Assert:
            await expect(AuthController.resendOTP(req, res)).rejects.toThrow(BadRequestError);
        });
    });
    describe("resetPassword", () => {
        ...
        it("should throw an error if email, otp or password is missing", async () => {
            ...
            // Act & Assert:
            await expect(AuthController.resetPassword(req, res)).rejects.toThrow(BadRequestError);
        });
