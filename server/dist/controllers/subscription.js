...
export const checkCompany = async ({ user }) => {
...
export const checkBilling = async ({ body }) => {
...
export const SubscriptionCtrl = {
    ...
    updateSubscription: async (req, res) => {
        ...
        // Calculate the next billing date from the current subscription's end date.
        const nextBillingDate = new Date(company.Subscription.endDate);
    ...
    cancelSubscription: async (req, res) => {
        ...
        const { deactivationDate } = await SubscriptionJobs.cancelSubscriptionJob({
            email: company.company_email,
            companyId: company.id,
            cancelDate: company.Subscription.endDate,
        });
    ...
    reactivateSubscription: async (req, res) => {
        ...
        if (error) {
            throw new CustomAPIError("Payment gateway initialization failed", StatusCodes.BAD_GATEWAY);
        }
