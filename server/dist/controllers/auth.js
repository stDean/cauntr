...
import { createJWT, generateVerificationToken, handleOtpForCompany, } from "../utils/authHelpers.js";
...
const checkOTP = async ({ email }) => {
    ...
    const { token, expires } = await generateVerificationToken(existingToken.email);
...
export const AuthController = {
    ...
    // 	});
    // },
    createCompanyStripe: async (req, res) => {
