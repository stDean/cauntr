...
router
    ...
    .post([AuthMiddleware, CheckActiveSubscription], TransactionsCtrl.sellProduct);
router
    .route("/products/bulkSell")
    .post([AuthMiddleware, CheckActiveSubscription], TransactionsCtrl.sellProducts);
// router
...
router
    ...
    .patch([AuthMiddleware, AdminMiddleware, CheckActiveSubscription], TransactionsCtrl.updateProductBalance);
router
    .route("/products/:itemId/updateSoldPrice")
    .patch([AuthMiddleware, AdminMiddleware, CheckActiveSubscription], TransactionsCtrl.updateSoldPrice);
